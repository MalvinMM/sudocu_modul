...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-xl-3">
            <a href="{{ route('addModuleCategory', $erp->Initials) }}" class="card-link">
                <div class="card overflow-hidden rounded-2">
                    <div class="card-body pt-5 pb-5 p-4 d-flex flex-column align-items-center justify-content-center">
                        <h5 class="card-title fw-semibold">Module Category</h5>
                        {{-- <div class="d-flex align-items-center justify-content-between">
                        <h6 class="fw-semibold fs-4 mb-0">$50 <span
                                class="ms-2 fw-normal text-muted fs-3"></span></h6>
                    </div> --}}
        ...
        <div class="col-sm-6 col-xl-3">
            <a href="{{ route('addReportCategory', $erp->Initials) }}" class="card-link">
                <div class="card overflow-hidden rounded-2">
                    <div class="card-body pt-5 pb-5 p-4 d-flex flex-column align-items-center justify-content-center">
                        <h5 class="card-title fw-semibold">Report Category</h5>
                        {{-- <div class="d-flex align-items-center justify-content-between">
                        <h6 class="fw-semibold fs-4 mb-0">$50 <span
                                class="ms-2 fw-normal text-muted fs-3"></span></h6>
                    </div> --}}
