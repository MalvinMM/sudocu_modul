...
@section('title')
    <h3 class="nav-link">Add Module</h3>
@endsection
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="#" method="POST" id="fullForm" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                    <label for="namaModul" class="form-label">Nama Modul <span style="color: red;">*</span></label>
                    <input type="text" class="form-control" id="namaModul" name="Name" value="{{ old('Name') }}">
                    @error('Name')
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" style="height:100px" id="ModuleDesc" name="ModuleDesc">{{ old('ModuleDesc') }}</textarea>
                    @error('ModuleDesc')
                        <h6 class="form-helper" style="color:red">{{ $message }}</h6>
                    @enderror
                </div>
                    ...
                    <div class="card-body position-relative">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="sequence" name="sequence[]"
                                style="width:10%" value="{{ old('sequence.0', 1) }}" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="Description" class="form-label">Deskripsi Sequence <span
                                    style="color: red;">*</span></label>
