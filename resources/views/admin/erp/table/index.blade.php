...
@section('content')
    ...
    <div class="card">
        ...
        <div class="table-responsive">
            <form action="{{ route('updateTable', [$erp]) }}" method="POST" style="margin-left: 0.5cm">
                @csrf
                @method('put')
                    ...
                    <tbody>
                        @foreach ($tables as $table)
                            <tr>
                                ...
                                <td class="border-bottom-0 text-center">
                                    <textarea name="description[]" class="form-control" rows="3" id="description_{{ $table->TableID }}">{{ $table->Description }}</textarea>
